...
unset($__errorArgs, $__bag); ?>"
                                                name="phone_number" value="<?php echo e(old('phone_number')); ?>" id="phone_number"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-4">
                                        <p class="mb-0 fs-12 text-muted fst-italic">By registering you agree to the LaundryHub 
                                            <a href="<?php echo e(route('terms')); ?>" class="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</a>
                                        </p>
                                    </div>
                    ...
                    <div class="mt-4 text-center signup-section">
                        <p class="mb-0">Already have an account? 
                            <a href="<?php echo e(route('login')); ?>" class="fw-semibold text-primary text-decoration-underline">Sign in</a>
                        </p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lifemate\Desktop\Velzon_v4.2.0\Laravel\saas\resources\views/auth/register.blade.php ENDPATH**/ ?>
            ...
            <div class="col-12 col-lg-auto order-last order-lg-0">
                <div class="row text text-white-50 text-center">
                    <div class="col-lg-6 col-4">
                        <div class="p-2">
                            <h4 class="text-white mb-1">{{ $totalOrders ?? 0 }}</h4>
                            <p class="fs-14 mb-0">Orders</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-4">
                        <div class="p-2">
                            <h4 class="text-white mb-1">{{ $totalEarnings ? 'Tsh ' . number_format($totalEarnings, 2) : 'Tsh 0.00' }}</h4>
            ...
            <div>
                <div class="d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ route('laundress.profile.edit') }}" 
                                            ...
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-muted">{{ auth()->user()->created_at->format('M d, Y') }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl">
                                                        <div class="text-muted">
                                                            {{ auth()->user()->business_name ?? 'Not set' }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pb-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl">
                                                        <div class="text-muted">
                                                            {{ auth()->user()->business_address ?? 'Not set' }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pb-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl">
                                                        <div class="text-muted">
                                                            {{ auth()->user()->business_description ?? 'No description available' }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

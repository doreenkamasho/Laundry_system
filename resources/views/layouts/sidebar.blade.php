...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <a href="{{ auth()->check() ? route(auth()->user()->role->name . '.dashboard') : route('root') }}" class="logo logo-dark">
            <span class="logo-sm">
                <i class="fas fa-tshirt fa-2x" style="color: var(--vz-primary)"></i>
            </span>
            <span class="logo-lg">
                <i class="fas fa-tshirt fa-3x" style="color: var(--vz-primary)"></i>
                <span class="logo-text">LaundryHub</span>
            </span>
        </a>
        <a href="{{ auth()->check() ? route(auth()->user()->role->name . '.dashboard') : route('root') }}" class="logo logo-light">
            <span class="logo-sm">
                <i class="fas fa-tshirt fa-2x" style="color: #fff"></i>
            </span>
            <span class="logo-lg">
                <i class="fas fa-tshirt fa-3x" style="color: #fff"></i>
                <span class="logo-text">LaundryHub</span>
            </span>
        </a>

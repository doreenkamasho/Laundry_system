...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a href="{{ route('laundress.services.index') }}" class="btn btn-primary">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('laundress.services.store') }}" method="POST" id="serviceForm">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-6">

...
<div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
    ...
    <div class="offcanvas-body p-0">
        <div data-simplebar class="h-100">
            <form action="<?php echo e(route('theme.save')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="p-4">
                    ...
                    <div id="sidebar-img">
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image"
                                    id="sidebarimg-05" value="img-5">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-05">
                                    <img src="<?php echo e(URL::asset('build/images/sidebar/img-5.jpg')); ?>"
                                        class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="mt-4 px-4 pb-4">
                        <button type="submit" class="btn btn-success w-100">
                            <i class="mdi mdi-content-save me-1"></i> Save Theme Settings
                        </button>
                    </div>
                </div>
            </form>
...
<script>
    document.getElementById('save-theme-settings').addEventListener('click', async function() {
        try {
            const settings = {
                theme: document.querySelector('input[name="data-bs-theme"]:checked')?.value || 'light',
                layoutStyle: document.querySelector('input[name="data-layout-style"]:checked')?.value || 'default',
                sidebar: document.querySelector('input[name="data-sidebar"]:checked')?.value || 'light',
                sidebarSize: document.querySelector('input[name="data-sidebar-size"]:checked')?.value || 'lg',
                sidebarImage: document.querySelector('input[name="data-sidebar-image"]:checked')?.value || 'none'
            };
...
<?php $__env->stopSection(); ?><?php /**PATH C:\Users\Lifemate\Desktop\Velzon_v4.2.0\Laravel\saas\resources\views/layouts/customizer.blade.php ENDPATH**/ ?>
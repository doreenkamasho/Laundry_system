...
window.L = L; // Make Leaflet globally available
		...
		if (document.documentElement.getAttribute("data-layout") === "semibox") {
			if (windowSize > 767) {
				...
				if(document.documentElement.getAttribute('data-sidebar-visibility') == "show") {
					...
					document.documentElement.setAttribute("data-sidebar-size", document.document.documentElement.getAttribute("data-sidebar-size"));
				}
			} else if (windowSize <= 767) {
				document.body.classList.add("vertical-sidebar-enable");
				document.documentElement.setAttribute("data-sidebar-size", "lg");
